...
datadict = np.load('../results/datadict.npy').item()
...
for seen_cat in seen:
    ...
    covariance_dict[seen_cat] = gmm.covars_[0]

    means.append(gmm.means_[0].tolist())
    covariances.append(gmm.covars_[0].tolist())
...
for unseen_cat in unseen:
    ...
    un_covariance_dict[unseen_cat] = gmm.covars_[0]

    un_means.append(gmm.means_[0].tolist())
    un_covariances.append(gmm.covars_[0].tolist())
